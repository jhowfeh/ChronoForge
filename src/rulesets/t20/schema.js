...
import { createT20EffectHandlers } from './engine/effects'
...
export const t20Schema = {
  ...
  skillGroups: {
   ...
   // ✅ engine hooks do ruleset (usado pelo core/computeDerivedBase)
  engine: {
    createEffectHandlers: createT20EffectHandlers
  },
